...
class Scoreboard:
  ...
  def prep_score(self):
    ...
    self.score_image = self.font.render(text, True, self.settings.text_color, self.settings.bg_color)
  ...
  def _prep_high_score(self):
    ...
    self.high_score_image = self.font.render(text, True, self.settings.text_color, self.settings.bg_color)
